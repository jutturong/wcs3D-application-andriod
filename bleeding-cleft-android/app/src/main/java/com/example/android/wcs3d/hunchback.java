...
public class hunchback  extends Activity
{
    ImageView imgback;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layouthunchback1);

        imgback=(ImageView)findViewById(R.id.imgback);
        imgback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(hunchback.this,harbor2.class);
                startActivity(i);
                finish();
            }
        });
        ...
        imgforword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(hunchback.this,hunchback2.class);
                startActivity(i);
                finish();
            }
        });
